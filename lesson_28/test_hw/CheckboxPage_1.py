...
from qa_auto_python.lesson_28.widgets.components import ExpandableTreeElement, CheckBox
...
class CheckboxPage:
    def __init__(self, driver, name):
        ...
        self.versatile_checkbox_button = f"//label[contains(@for, 'tree-node-{name}')]//ancestor::span/button"

    def open(self):
        self.driver.get(URL)
        return self

    def expand_folder_1(self):
        return CheckBox()
